...
///////////////////////////////////////////////////////https://yonghwankim-dev.tistory.com/196?category=990150
///////////////////////////////////////////////////////
...
### 멀티쓰레딩 문제 해결 방법
- **락 사용**: `mutex`나 `semaphore`를 활용하여 자원의 동시 접근을 제어한다.
- **타임아웃 설정**: 락 대기 시 타임아웃을 설정하여 무한 대기 상태를 방지한다.
- **교착 상태 회피 알고리즘**: 데드락 회피를 위해 자원 할당 시 순서에 맞게 요청하거나 순환 대기를 방지한다.

#### 뮤텍스(Mutex)와 세마포어(Semaphore)의 차이

////////////////////////////////////////////////////////////
뮤텍스는 공유 자원에 대한 접근을 제어하기 위한 상호 배제 기법 중 하나로 Lock을 사용해 하나의 프로세스나 스레드를 단독으로 실행하게 합니다.
반면에 세마포어는 동시에 접근 가능한 스레드의 개수를 지정할 수 있습니다. 세마포어 값이 1이면 뮤텍스와 동일한 역할을 하며, 값이 2 이상이면 동시에 접근 가능한 스레드 수를 제어합니다.
